define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "subject",
            "description": "<p>Subject of the email</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
  ...
  {
    "type": "GET",
    "url": "/customer/profile?id=:customer_id",
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "msg",
            "description": "<p>Returns &quot;success&quot; if registration is successful</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
  ...
  {
    "type": "POST",
    "url": "reservation/:res/:ftype/document/",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "ftype",
            "description": "<p>UUID of filetype returned from requirement</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "files",
            "description": "<p>File Object List</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "obslete",
            "description": "<p>Whether this document is outdated, pass False for now.</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "DELETE",
    "url": "reservation/:res/:ftype/document/:id",
  ...
  {
    "type": "GET",
    "url": "reservation/:res/:ftype/document/?owner=:user_id",
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "user_id",
            "description": "<p>UUID of owner of a document</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "name": "CreateFileType",
    "description": "<p>Create a file type</p>",
    "group": "Filetype",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "name",
            "description": "<p>name of the ftype. e.g. passport</p>"
          },
          {
            "group": "Parameter",
            "type": "String",
            "optional": false,
            "field": "description",
            "description": "<p>Description of the file type. e.g. 护照扫描件</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Ftype ID. This will be changed to UUID soon.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "obsolete",
            "description": "<p>Whether this ftype is obsolete and not used anymore.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "extensions",
            "description": "<p>This field is currently unused</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
  ...
  },
  {
    ...
    "name": "GetFileType",
    "description": "<p>et a specific file type</p>",
    "group": "Filetype",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "ftid",
            "description": "<p>ID of the file type to get</p>"
          }
        ]
      }
    },
        ...
        "Error 4xx": [
          {
            ...
            "optional": false,
            "field": "FTypeNotFound",
            "description": "<p>The requested ftype was not found.</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "POST",
    "url": "/ftype/:ftid/retire",
    "title": "Retire (obsolete) a file type",
    "name": "RetireFileType",
    "description": "<p>Retire (obsolete) a file type.</p>",
    "group": "Filetype",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "ftid",
            "description": "<p>ID of the file type to retire</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "format",
            "description": "<p>Question format code.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "title": "Question Info",
    "name": "QuestionInfo",
    "description": "<p>Request information about a</p>",
    "group": "Question",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  {
    "type": "POST",
    "url": "/requirement/alter",
    "title": "Alter/Create a document requirement",
    "name": "AlterRequirement",
    "description": "<p>Alter/Create a document requirement.</p>",
    "group": "Requirement",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "types",
            "description": "<p>List of IDs of file type (ftype) for this requirement</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "type": "Number[]",
            "optional": false,
            "field": "obsolete_types",
            "description": "<p>List of IDs of obsolete file types</p>"
          },
          {
            "group": "Success 200",
            "type": "Object",
            "optional": false,
            "field": "created",
            "description": "<p>Current status of the requirement</p>"
          },
          {
            "group": "Success 200",
            "type": "UUID",
            "optional": false,
            "field": "created.disease_id",
            "description": "<p>Disease ID</p>"
          },
          {
            "group": "Success 200",
          ...
          },
          {
            ...
            "optional": false,
            "field": "created.types",
            "description": "<p>IDs of required document types. This field will be changed to UUID[] soon.</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "name": "GetRequirement",
    "description": "<p>Display a document requirement.</p>",
    "group": "Requirement",
    "parameter": {
      "fields": {
        "Parameter": [
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "description": "<p>Whether this user has been verified and is active</p>"
          },
          {
            "group": "Success 200",
            "type": "Boolean",
            "optional": false,
            "field": "user.is_staff",
            "description": "<p>Whether this user is a is staff</p>"
          },
          {
            "group": "Success 200",
            "type": "Boolean",
            ...
            "description": "<p>Whether this user is a superuser</p>"
          },
          {
            "group": "Success 200",
            "type": "Datetime",
          ...
          },
          {
            ...
            "optional": false,
            "field": "user.groups",
            "description": "<p>Groups that this user belongs to</p>"
          },
          {
            "group": "Success 200",
            "type": "String[]",
            "optional": false,
            "field": "user.user_permissions",
            "description": "<p>Permissions that this user has</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "msg",
            "description": "<p>I don't know what it is nor why we are returning it</p>"
          }
        ]
      }
    },
  ...
  },
  {
    ...
    "name": "StaffSummary",
    "description": "<p>Request a summary of the staff's stats.</p>",
    "group": "Staff",
    "parameter": {
      "fields": {
        "Parameter": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "reservation",
            "description": "<p>The id of the reservation to which the transaction belongs</p>"
          }
        ]
      }
    },
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "UUID",
            "optional": false,
            "field": "transactions.reservation",
            "description": "<p>ID of the reservation under whom this transaction was created</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "transactions.provider_transaction_no",
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "transactions.out_trade_no",
            "description": "<p>Unique transaction number in our system (consumed by Alipay/WeChat Pay)</p>"
          },
          {
            "group": "Success 200",
            "type": "Number",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "String",
            "optional": false,
            "field": "transaction.provider_transaction_no",
            "description": "<p>Trade number returned by Alipay or Wechat</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "transaction.out_trade_no",
            "description": "<p>Unique transaction number in our system (consumed by Alipay/WeChat Pay)</p>"
          },
          {
            "group": "Success 200",
